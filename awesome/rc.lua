...
package.path = package.path .. ';/usr/share/awesome/lib/awful/?.lua'
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Escape",function () util.spawn("slimlock") end),     
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () util.spawn("dmenu_run") end),
...
-- Autostart things
util.spawn_with_shell("compton")
util.spawn_with_shell("nitrogen --restore")
--util.spawn_with_shell("python3 /home/tomerh/PycharmProjects/colorup/main.py")
--util.spawn_with_shell("firefox")
